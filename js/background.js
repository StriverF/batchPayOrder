    ...
    chrome.storage.local.get("tabids",function(items){
      ...
      if (isTab) {
        chrome.tabs.get(tabId, function(tab){
          ...
          }else if(tab.url.startsWith("https://cashierew9.alipay.com/standard/lightpay/lightPayCashier.htm") 
          || tab.url.startsWith("https://cashiergtj.alipay.com/standard/lightpay/lightPayCashier.htm")
          || tab.url.startsWith("https://cashiersu18.alipay.com/standard/lightpay/lightPayCashier.htm")){ //企业支付宝支付页面
            chrome.tabs.executeScript(tab.id, {file: "js/AliPay.js"}, function(){
                chrome.tabs.sendMessage(tab.id, {
                  "type": "order_amount", 
                  "order": stay_pay_order,
